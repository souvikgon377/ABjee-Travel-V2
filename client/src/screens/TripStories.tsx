          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            {!isEdit && (
              <div className="bg-rose-500/10 border border-rose-500/20 rounded-xl p-3 flex items-start gap-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold text-rose-700 dark:text-rose-400">Earn 5 ABjee Points!</div>
                  <p className="text-[11px] text-muted-foreground mt-0.5">
                    Share your experience and earn 5 ABjee points in your wallet upon submitting. Points will be reversed if this story is deleted.
                  </p>
                </div>
              </div>
            )}
